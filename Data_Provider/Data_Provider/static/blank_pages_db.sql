...
CREATE TABLE blank_pages.articles (
	...
	FOREIGN KEY(author_id) REFERENCES blank_pages.authors(id) ON DELETE CASCADE
);
...
CREATE TABLE blank_pages.sources (
	...
	FOREIGN KEY(parent_article_id) REFERENCES blank_pages.articles(id) ON DELETE CASCADE
);
